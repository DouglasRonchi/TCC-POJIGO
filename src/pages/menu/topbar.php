...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        <script async src="https://cse.google.com/cse.js?cx=011766867709222014939:rtfjrxmg5cp"></script>
    ...
    <script>
        ...
        function demo() {
            document.getElementById("gsc-i-id1").setAttribute("placeholder", "Pesquisar no site...")
        }
    </script>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= (isset($_SESSION['nome'])) ? utf8_encode($_SESSION['nome']) : ''; ?></span>
                <img class="img-profile rounded-circle"
                     src="../../../uploads/<?= (isset($_SESSION['foto']) && $_SESSION['foto'] != '') ? $_SESSION['foto'] : 'default.png'; ?>">
            </a>
